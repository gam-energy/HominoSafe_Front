...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: "/verify-email", destination: `${t}/verify-email` },
      { source: "/verify-email/:path*", destination: `${t}/verify-email/:path*` },
      { source: "/activate-nest", destination: `${t}/activate-nest` },
      { source: "/onboarding-status", destination: `${t}/onboarding-status` },
      { source: "/register/b2c", destination: `${t}/register/b2c` },
      ...
      { source: "/device", destination: `${t}/device` },
